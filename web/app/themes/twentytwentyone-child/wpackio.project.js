...
module.exports = {
	// Project Identity
	appName: 'twentytwentyoneChild', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'twentytwentyone-child', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	// Used to generate banners on top of compiled stuff
	bannerConfig: {
		name: 'twentytwentyoneChild',
		author: 'Michael Withagen',
		license: 'ISC',
		link: 'ISC',
		version: pkg.version,
		copyrightText:
